...
public class SellerAddNewProductActivity extends AppCompatActivity
{
    ...
    private DatabaseReference productsRef , sallersRef ;
    private ProgressDialog loadingBar;

    private String sName ,sAddreess, sPhone , sId,sEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sallersRef = FirebaseDatabase.getInstance().getReference().child("selers");
        ...
        sallersRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            sAddreess = snapshot.child("address").getValue().toString();
...
//        final UploadTask uploadTask = filePath.putFile(ImageUri);
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        productMap.put("sellerAddress", sAddreess );
        ...
        productsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(SellerAddNewProductActivity.this, SellersHomeMainActivity.class);
